...
export default function EditorialHero() {
  ...
  return (
    <div ref={ref} className="relative flex min-h-screen items-center overflow-hidden">
      {/* Watermark number */}
      <span className="pointer-events-none absolute right-6 top-1/2 -translate-y-1/2 select-none text-[clamp(10rem,25vw,18rem)] font-bold leading-none text-text/[0.04] hidden sm:block md:right-12"
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6 md:px-12">
        ...
        >
          <motion.div
            ...
            className="h-[3px] w-16 origin-left bg-accent md:w-24"
          />
          <motion.h2
